      ...
      <section className="my-8">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white shadow-lg rounded-lg p-4 text-center transition-transform transform hover:scale-105">
            ...
            <a href="mailto:santiago.reyess.com" className="mt-4 inline-block bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600 transition duration-300">Enviar Correo</a>
          </div>
