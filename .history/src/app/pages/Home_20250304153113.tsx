  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <section className="my-8 text-center">
        ...
        <blockquote class="imgur-embed-pub" lang="en" data-id="a/XwfOfNi"  ><a href="//imgur.com/a/XwfOfNi">ffuuygtyio</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>
