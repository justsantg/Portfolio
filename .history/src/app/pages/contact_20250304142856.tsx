      ...
      <section className="my-8">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white shadow-lg rounded-lg p-4 text-center transition-transform transform hover:scale-105">
            ...
            <a href="https://github.com/tu-usuario" target="_blank" rel="noopener noreferrer" className="mt-4 inline-block bg-gray-800 text-white p-2 rounded-lg hover:bg-gray-900 transition duration-300">GitHub</a>
            <a href="https://linkedin.com/in/tu-usuario" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block bg-blue-700 text-white p-2 rounded-lg hover:bg-blue-800 transition duration-300">LinkedIn</a>
            <a href="https://instagram.com/tu-usuario" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block bg-pink-500 text-white p-2 rounded-lg hover:bg-pink-600 transition duration-300">Instagram</a>
          </div>
        </div>
      </section>
    </main>
