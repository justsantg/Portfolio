...
const projects = [
  ...
  },
  {
    id: 2,
    title: 'Pet-app',
    image: 'https://miro.medium.com/v2/resize:fit:1200/1*JsrpgUFsLNEtWAWYKs8LIg.jpeg', // Reemplaza con la URL de la imagen del proyecto
    githubLink: 'https://github.com/justsantg/pet_app.git', // Reemplaza con el enlace a tu repositorio
  },
  {
    id: 3,
    title: 'Gym Frontend',
    image: 'https://cdn.mos.cms.futurecdn.net/KGZVRurkMGfpk7P7Cm87Wh.jpg', // Reemplaza con la URL de la imagen del proyecto
    githubLink: 'https://github.com/justsantg/gym-frontend.git', // Reemplaza con el enlace a tu repositorio
  },
